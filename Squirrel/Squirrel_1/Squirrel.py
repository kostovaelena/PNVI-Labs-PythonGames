...
MOVERATE = 15 # Promena na moverate
#BOUNCERATE = 6       # how fast the player bounces (large is slower)
BOUNCERATE = 20 # Promena na bouncerate
BOUNCEHEIGHT = 30    # how high the player bounces
STARTSIZE = 25       # how big the player starts off
WINSIZE = 300        # how big the player needs to be to win
#INVULNTIME = 2       # how long the player is invulnerable after being hit in seconds
# Promena na invulntime
INVULNTIME = 5       # how long the player is invulnerable after being hit in seconds
...
# Promena na minimalnata i maksimalnata brzina na ververichkite
SQUIRRELMINSPEED = 8 # slowest squirrel speed
SQUIRRELMAXSPEED = 10 # fastest squirrel speed
#DIRCHANGEFREQ = 2    # % chance of direction change per frame
# Zgolemuvanje na shansata da se promeni direkcijata na neprijatelskite ververichki
DIRCHANGEFREQ = 20    # % chance of direction change per frame
LEFT = 'left'
RIGHT = 'right'

# Definiranje na posebni CAMERASLACK_X i CAMERASLACK_Y soodvetno
CAMERASLACK_X = 80
CAMERASLACK_Y = 60
...
def main():
    ...
    # Dodavanje na dve novi sliki na kamen i drvo vo igrata
    GRASSIMAGES.append(pygame.image.load('rsz_1rock.png'))
    GRASSIMAGES.append(pygame.image.load('rsz_drvo.png'))
...
def runGame():
    ...
    # Dodavanje 3 novi ververichki vo delot na camera view
    for i in range(3):
        squirrelObjs.append(makeNewSquirrel(camerax, cameray))
        squirrelObjs[i]['x'] = random.randint(0, HALF_WINWIDTH)
        squirrelObjs[i]['y'] = random.randint(0, HALF_WINHEIGHT)
    ...
    while True: # main game loop
        ...
        # Zamena na CAMERASLACK vo CAMERASLACK_X i CAMERASLACK_Y soodvetno
        ...
        flashIsOn = round(time.time(), 1) * 100 % 2 == 1 # Namaluvanje na intervalot na flashIsOn na 1/100 od sekunda
